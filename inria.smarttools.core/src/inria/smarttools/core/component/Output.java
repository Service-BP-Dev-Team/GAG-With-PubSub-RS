 ...
 * 
 *******************************************************************************/
// $Id: Output.java 2738 2009-02-24 13:36:10Z bboussema $
package inria.smarttools.core.component;

import java.util.Map;

/**
 * Output.java Created: Tue Mar 05 14:04:56 2002
 * 
 * @author <a href="mailto:Didier.Parigot@sophia.inria.fr">Didier Parigot</a>
 * @version $Revision: 2738 $
 */
public class Output extends ServiceImpl implements Service {

	protected Map<String, Attribute> attributes;

	public Output(final String name, final Map<String, Attribute> attributes,
