...
/**
 **/
public class SmartWorkflowGUIFacade extends SmartWorkflowGUI implements SmartWorkflowGUIFacadeInterface {
   //
   // Fields 
   //
    ...
    * Constructor
    **/
   public   SmartWorkflowGUIFacade(String idName){
      setIdName(idName);
   }
