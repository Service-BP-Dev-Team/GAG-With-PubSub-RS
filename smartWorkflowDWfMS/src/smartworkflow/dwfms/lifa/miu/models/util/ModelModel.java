 ...
 */
package smartworkflow.dwfms.lifa.miu.models.util;
...
import smartWorkflowDWfMS.SmartWorkflowDWfMS;
import smartworkflow.dwfms.lifa.miu.controllers.IHMController;
...
import smartworkflow.dwfms.lifa.miu.util.observer.adapters.ObservableAdapter;
import smartworkflow.dwfms.lifa.miu.view.AuthentificationDialog;
import smartworkflow.dwfms.lifa.miu.view.LoadingDialog;
import smartworkflow.dwfms.lifa.miu.view.SettingGUIDialog;
import smartworkflow.dwfms.lifa.miu.view.WorkspaceDialog;
import smartworkflow.dwfms.lifa.miu.view.util.editor.AvatarDialog;
import smartworkflow.dwfms.lifa.miu.view.util.editor.SmilieDialog;
...
public abstract class ModelModel extends ObservableAdapter{
    ...
    public static SmartWorkflowDWfMS thisSONCommunicationInterface;
    public static boolean display = true;
    private static LoadingDialog loadingDialog;
    protected static Desktop desktop = null;
    
    protected static IHMController ihmController = new IHMController(new IHMModel());;

    public static ControllerModel getIHMController() {
        return ihmController;
    }
    
    public static IEditorController getIEditorController() {
        return ihmController;
    }
    ...
    public ModelModel(ConfigurationManager config) {
        ...
        loadingDialog = new LoadingDialog(config, false, null, ihmController);
    }
