...
/**
 **/
public class SmartWorkflowDWfMSFacade extends SmartWorkflowDWfMS implements SmartWorkflowDWfMSFacadeInterface {
   //
   // Fields 
   //
    ...
    * Constructor
    **/
   public   SmartWorkflowDWfMSFacade(String idName){
      setIdName(idName);
   }
    ...
    * Constructor
    **/
   public   SmartWorkflowDWfMSFacade(){
   }
    ...
    **/
   public  void inReturnTo(String expeditor, java.lang.String repliquePartielle){
      super.inReturnTo(expeditor, repliquePartielle);
   }
    ...
    * @param expeditor is the component name who sent this message
    **/
   public  void inForwardTo(String expeditor, java.lang.String repliquePartielle){
      super.inForwardTo(expeditor, repliquePartielle);
   }
    ...
    * @param ev a <code>Object</code> value : data
    **/
   public  void outReturnTo(java.lang.String repliquePartielle){
      outReturnTo(null, repliquePartielle);
   }
    ...
    * @param ev a <code>Object</code> value : data
    **/
   public  void outReturnTo(String adressee, java.lang.String repliquePartielle){
      PropertyMap args = new PropertyMap();
      args.put("repliquePartielle",repliquePartielle);
      ReturnToEvent ev =  new ReturnToEvent(adressee, repliquePartielle);
      ev.setAttributes(args);
    ...
    * @param ev a <code>Object</code> value : data
    **/
   public  void outForwardTo(java.lang.String repliquePartielle){
      outForwardTo(null, repliquePartielle);
   }
    ...
    * @param ev a <code>Object</code> value : data
    **/
   public  void outForwardTo(String adressee, java.lang.String repliquePartielle){
      PropertyMap args = new PropertyMap();
      args.put("repliquePartielle",repliquePartielle);
      ForwardToEvent ev =  new ForwardToEvent(adressee, repliquePartielle);
      ev.setAttributes(args);
