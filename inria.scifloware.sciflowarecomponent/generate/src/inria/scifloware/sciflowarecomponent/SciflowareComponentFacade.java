...
/**
 **/
public class SciflowareComponentFacade extends SciflowareComponent implements SciflowareComponentFacadeInterface {
   //
   // Fields 
   //
    ...
    * Constructor
    **/
   public   SciflowareComponentFacade(String idName){
      setIdName(idName);
   }
    ...
    * Constructor
    **/
   public   SciflowareComponentFacade(){
   }
